<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="书城分类" prop="shuchengfenlei">
          <el-select :disabled="ro.shuchengfenlei" v-model="ruleForm.shuchengfenlei" placeholder="请选择书城分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="书城分类" prop="shuchengfenlei">
	      <el-input v-model="ruleForm.shuchengfenlei"
                placeholder="书城分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作者姓名" prop="zuozhexingming">
          <el-input v-model="ruleForm.zuozhexingming" 
              placeholder="作者姓名" clearable  :readonly="ro.zuozhexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作者姓名" prop="zuozhexingming">
              <el-input v-model="ruleForm.zuozhexingming" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="图书内容" prop="tushuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tushuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tushuneirong" label="图书内容" prop="tushuneirong">
                    <span v-html="ruleForm.tushuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          shuchengfenlei: [
                { required: true, message: '书城分类不能为空', trigger: 'blur' },
          ],
          jianjie: [
          ],
          zuozhexingming: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
          ...
          if(o=='shuchengfenlei'){
            this.ruleForm.shuchengfenlei = obj[o];
	    this.ro.shuchengfenlei = true;
            continue;
          }
          if(o=='jianjie'){
	    ...
	    this.ro.shangjiariqi = true;
          ...
          if(o=='tushuneirong'){
            this.ruleForm.tushuneirong = obj[o];
	    this.ro.tushuneirong = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.tushuneirong = this.ruleForm.tushuneirong.replace(reg,'../../../ssmn11j0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shuchengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shuchengxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
