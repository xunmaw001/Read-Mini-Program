<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="书城分类" prop="shuchengfenlei">
          <el-input v-model="ruleForm.shuchengfenlei" 
              placeholder="书城分类" clearable  :readonly="ro.shuchengfenlei"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shuchengfenlei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shuchengfenleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
